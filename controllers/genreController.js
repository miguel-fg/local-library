...
// Doesn't need asyncHandler because it doesn't contain any code that can throw exceptions
...
exports.genre_delete_get = asyncHandler(async (req, res, next) => {
    // Get details of genre and all the books in it (in parallel)
    ...
    if (genre === null) {
        //No results, redirect to the list of all genres
